...
function display() {
    ...
    for (var i = 0; i < projects_json.projects.length; i++) {
        var link = projects_json.projects[0].name.toLowercase.replace(" ", "-");
        var name = projects_json.projects[0].name;
        var date = projects_json.projects[0].date;
        var text = projects_json.projects[0].text;
